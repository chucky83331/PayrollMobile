    ...
    internal class PayrollMobile
    {
        public partial class MainPage : ContentPage
        {
            ...
            async void OnButtonClicked(object sender, EventArgs e)
            {
                ...
                await App.Database.SaveShiftAsync(new ContentPage
                {
            ...
            ContentPage lastSelection;
            private void CV_SelectionChanged(object sender, SelectionChangedEventArgs e)
            {
                lastSelection = e.CurrentSelection[0] as ContentPage;
